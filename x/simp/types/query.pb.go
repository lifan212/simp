...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3452e5fdac373514, []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3452e5fdac373514, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "simp.simp.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "simp.simp.QueryParamsResponse")
}

func init() { proto.RegisterFile("simp/simp/query.proto", fileDescriptor_3452e5fdac373514) }

var fileDescriptor_3452e5fdac373514 = []byte{
	...
	0x1c, 0x06, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6c, 0x31, 0x84, 0x1c, 0xb2, 0x01, 0x00,
	0x00,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/simp.simp.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simp.simp.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "simp/simp/query.proto",
}
