...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_82ca0d06839cbc41, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_82ca0d06839cbc41, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "simp.simp.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "simp.simp.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("simp/simp/tx.proto", fileDescriptor_82ca0d06839cbc41) }

var fileDescriptor_82ca0d06839cbc41 = []byte{
	...
	0x4c, 0x9e, 0x9f, 0xf4, 0xf4, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/simp.simp.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simp.simp.Msg/UpdateParams",
	}
